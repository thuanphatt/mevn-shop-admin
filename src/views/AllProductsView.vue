      ...
      <div class="col-md-12">
        <div class="card card-bg-primary">
          <div class="card-header">
            <h4 class="font-weight-bolder text-black">All products</h4>
          </div>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-white opacity-7">
                      Category
                    </th>
                ...
                <tbody>
                  <tr
                    ...
                    v-bind:key="product._id.toString()"
                  >
                    <td>
                      <span v-text="product.name" class="text-white"></span>
                    </td>
                    <td>
                      <span v-text="product.category" class="text-white"></span>
                    </td>

                    <td class="text-white">
                      $<span v-text="product.price" class="text-white"></span>
                    </td>

                    <td>
                      <span
                        v-text="product.itemsInStock || 0"
                        class="text-white"
                      ></span>
                    </td>
                    ...
                    <td>
                      <div style="display: flex">
                        <router-link
                          v-bind:to="'/product/edit/' + product._id"
                        ...
                        <form v-on:submit.prevent="deleteProduct">
                          ...
                          <input
                            type="submit"
                            name="submit"
                            class="btn btn-xs bg-gradient-primary deleteButton"
                            value="Delete"
                            style="background-color: #e53935; box-shadow: none"
                          />
                        </form>
                      </div>
                    </td>
