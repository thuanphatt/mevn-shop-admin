  ...
  >
    <div class="sidenav-header">
      <i
        ...
        id="iconSidenav"
      ></i>
      <a class="navbar-brand m-0" href.prevent="#" target="_blank">
        <img
          src="../../../public/assets/img/logo-ct.png"
          class="navbar-brand-img h-100"
          alt="main_logo"
        />
        <span class="ms-1 font-weight-bold text-white text-uppercase"
          >Admin</span
        >
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          >
            ...
            <span
              v-if="unReadOrderNotifications > 0"
              v-text="'(' + unReadOrderNotifications + ')'"
